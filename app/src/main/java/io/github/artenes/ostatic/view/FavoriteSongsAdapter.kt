...
import kotlinx.android.synthetic.main.favorite_song.view.*

class FavoriteSongsAdapter(val listener: OnSongClickListener) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FavoriteSongViewHolder {
        ...
        val view = inflater.inflate(R.layout.favorite_song, parent, false)
    ...
    inner class FavoriteSongViewHolder(view: View) : RecyclerView.ViewHolder(view), View.OnClickListener {

        fun bind(position: Int, song: SongView) {
            val resources = itemView.context.resources
            itemView.setOnClickListener(this)
            itemView.songName.text = song.name
            itemView.songAlbum.text = song.albumName
            Picasso.get().loadAlbumCover(song.albumCover, itemView.albumCover, 120)
